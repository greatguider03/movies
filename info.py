...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://abhiikum:abhiikum@abhiikum.8puetsd.mongodb.net/?retryWrites=true&w=majority&appName=abhiikum
")
DATABASE_NAME = environ.get('DATABASE_NAME', "abhiikum")
